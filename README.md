...
The project is ready for GitHub Pages. After enabling GitHub Pages for the repository, the local HTML app can be used as a public demo page:
...
项目已经适合开启GitHub Pages。开启后，HTML本地应用可以作为公开演示页面使用：
